...
module Geom
  ...
  def Geom.point_in_polygon_loop(point, polygon_loop, include_border = false)
    ...
    # This is a 3-D substitute for point_in_polygon_2D, which does not seem to be functional.

    polygon_loop.valid?  # tests that everything is in the plane, and has >3 vertices
